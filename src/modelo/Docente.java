...
public class Docente extends Persona {
    ...
    public DefaultTableModel leer() {
        ...
        try {
            ...
            String encabezado[] = {"Id", "Nit", "Nombres", "Apellidos", "Dirección", "Teléfono", "Nacimiento", "Código", "Salario", "Ingreso Laboral", "Ingreso Registro"};
    ...
    public void agregar() {
        try {
            ...
            cn = new Conexion();
            cn.abrir_conexion();
            String query = "INSERT INTO persona (nit, nombres, apellidos, direccion, telefono, fecha_nacimiento, codigo, salario, fecha_ingreso_laborar, fecha_ingreso_registro) " +
                           "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?);";
    ...
    public void actualizar() {
        try {
            ...
            cn = new Conexion();
            cn.abrir_conexion();
            String query = "UPDATE persona SET nit = ?, nombres = ?, apellidos = ?, direccion = ?, telefono = ?, fecha_nacimiento = ?, " +
                           "codigo = ?, salario = ?, fecha_ingreso_laborar = ?, fecha_ingreso_registro = ? WHERE id_persona = ?;";
            parametro = (PreparedStatement) cn.conexionBD.prepareStatement(query);
            parametro.setString(1, getNit());
            parametro.setString(2, getNombres());
            parametro.setString(3, getApellidos());
